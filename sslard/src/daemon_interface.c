...
int daemonize_init( const char command, int* status )
{
	...
	else	// the daemon
	{
		...
		// TESTING **************************************************************************************************
		// disabling all ftdi comms due to failure
		...
		// TODO - convert all prints to daemon log msg's
		...
		// TESTING - hook up signal handler
        ...
        while (!quit)
		{
			...
			// TESTING **************************************************************************************************
			// camera device failing, using cam device instead for now
			...
			{				
                ...
                switch( sig )
				{
                    ...
                    case SIGTERM:
						...
						// TESTING **************************************************************************************************
						// disabling all ftdi coms due to failure
